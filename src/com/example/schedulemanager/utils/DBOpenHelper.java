...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS schedule(scheduleID integer primary key autoincrement,content text,begin_time text,end_time text,tip_time text,isTip integer,isDone integer,isGroup integer)");
