...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.example.schedulemanager.services", "alarm", ALARMS);
        sURLMatcher.addURI("com.example.schedulemanager.services", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, day, month, year, alarmtime, enabled, vibrate, message, alert) " +
                    "VALUES ";
