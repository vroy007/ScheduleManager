...
public class AlarmAlertFullScreen extends Activity {
    ...
    private void setTitle() {
        ...
        TextView contents = (TextView) findViewById(R.id.alertContents);
        time.setText( "时间：" + mAlarm.month + "/" + mAlarm.day + "  " + mAlarm.hour + ":" + mAlarm.minutes);
        contents.setText("日程：" + mAlarm.label);
    }
...
//        label = getString(R.string.alarm_notify_snooze_label, label);
        ...
        String displayTime = snoozeMinutes + "";
        // Intentionally log the snooze time for debugging.
        Log.v("wangxianming", " AlarmAlertFullScreen"+displayTime);

        // Display the snooze minutes in a toast.
        Toast.makeText(AlarmAlertFullScreen.this, displayTime + "分钟后提醒",
