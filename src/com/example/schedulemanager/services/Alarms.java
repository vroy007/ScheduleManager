...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.example.schedulemanager.services.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.example.schedulemanager.services.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.example.schedulemanager.services.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.example.schedulemanager.services.ALARM_DISMISS";
...
//        }
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(Properties.PREFERENCES, 0);
...
//            }
    ...
    private static long calculateAlarm(Alarm alarm) {
        return calculateAlarm(alarm.hour, alarm.minutes, alarm.day, alarm.month, alarm.year)
                .getTimeInMillis();
    }
...
//        if(c.getTimeInMillis() - System.currentTimeMillis() > 0)
    ...
    static String formatTime(final Context context, int hour, int minute,
    			int day, int month, int year) {
        Calendar c = calculateAlarm(hour, minute, day, month, year);
